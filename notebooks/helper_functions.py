#import osmosdr UNCOMMENT BEFORE USING BLADERF
import numpy as np
...
def get_osmosdr_source(frequency, samp_rate=3500000, biastee=False, bandwidth=0):
    """Returns an instance of an OsmoSDR Source for the bladeRF

        Parameters
        ----------
        frequency : int
            The frequency that the bladeRF shall tune to
        samp_rate : int
            The sample rate of the IF stage of the bladeRF
            default: 3.5Msps
        biastee : boolean
            DC power injection on RX1 SMA of the bladeRF
            default: False (DC is OFF)
        bandwidth : int
            Override default bandpass filter of the bladeRF
            default: 0
...
def get_omsosdr_sink(frequency, samp_rate=3500000, biastee=False, bandwidth=0):
    """Returns an instance of an OsmoSDR Sink for the bladeRF
